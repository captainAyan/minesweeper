...
class MainApplication(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        btn_style = {'borderwidth': "0", 'font': custom_font, 'bd': '2', 'fg': "black", 'anchor': "w", 'padx': 5, 'bg': '#dedede'}
    ...
    def check(self, x, y):
        if self.game_state == 'playing' and not self.board[x][y].flagged and not self.board[x][y].checked:
            ...
            if self.board[x][y].value == "0":
                ...
                # | |o| |
                # | | | |
                if x - 1 >= 0 and y - 1 >= 0 and not self.board[x - 1][y - 1].checked and self.board[x - 1][y - 1].value != "x":
                    self.check(x - 1, y - 1)
                ...
                # | |o| |
                # | | | |
                if x + 1 < 10 and y - 1 >= 0 and not self.board[x + 1][y - 1].checked and self.board[x + 1][y - 1].value != "x":
                    self.check(x + 1, y - 1)
                ...
                # | |o| |
                # |x| | |
                if x - 1 >= 0 and y + 1 < 10 and not self.board[x - 1][y + 1].checked and self.board[x - 1][y + 1].value != "x":
                    self.check(x - 1, y + 1)
                ...
                # | |o| |
                # | | |x|
                if x + 1 < 10 and y + 1 < 10 and not self.board[x + 1][y + 1].checked and self.board[x + 1][y + 1].value != "x":
                    self.check(x + 1, y + 1)
        pass
